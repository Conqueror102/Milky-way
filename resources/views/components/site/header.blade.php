...
<header x-data="{ open: false }" class="fixed inset-x-0 top-0 z-50 px-4 pt-4 sm:px-6 sm:pt-6">
    <div class="mx-auto grid max-w-7xl grid-cols-[1fr_auto_1fr] items-center gap-4">
        ...
        <nav aria-label="Primary" class="liquid-glass hidden w-fit items-center gap-1 justify-self-start rounded-full p-1.5 lg:flex">
        ...
        >
            ...
            <span class="flex flex-col leading-none">
                <span class="text-[0.82rem] font-bold tracking-[0.16em] text-cosmic-900 uppercase lg:text-[0.9rem]">Milkyway</span>
                <span class="font-sub mt-1 text-[0.48rem] font-semibold tracking-[0.18em] text-cosmic-900/60 uppercase lg:text-[0.54rem] whitespace-nowrap">Cosmetics Stores</span>
            </span>
        </a>
