...
<section id="top" class="relative isolate flex h-[100svh] flex-col justify-end overflow-hidden bg-sand lg:justify-center">
    ...
    <picture>
        ...
        <img
            ...
            fetchpriority="high"
            class="absolute inset-0 -z-20 size-full object-cover object-[68%_top] lg:object-top"
        />
    </picture>
    ...
    <div class="mx-auto w-full max-w-7xl bg-[linear-gradient(to_bottom,transparent_0,var(--color-sand)_5.5rem)] px-6 pt-24 pb-7 max-lg:[@media(max-height:700px)]:pt-12 sm:px-8 sm:pb-9 lg:bg-none lg:pt-24 lg:pb-8">
        <div class="max-w-xl lg:max-w-3xl">

            {{-- Eyebrow --}}
            <div class="flex items-center gap-3">
                <span class="h-px w-6 bg-cosmic-900/35 sm:w-10"></span>
                <span class="font-sub text-[0.6rem] font-medium tracking-[0.2em] text-cosmic-900/70 uppercase sm:text-[0.68rem] sm:tracking-[0.32em]">
            ...
            <h1 class="mt-5 max-lg:[@media(max-height:700px)]:mt-3 text-[clamp(2.6rem,min(7.4vw,13vh),6.25rem)] leading-[1] font-bold tracking-[-0.01em] text-cosmic-900">
                <span class="block">Your Beauty.</span>
                <span class="mt-2 block ps-1 lg:ps-16">
            ...
            {{-- Supporting copy --}}
            <p class="font-sub mt-6 max-lg:[@media(max-height:700px)]:mt-4 max-w-lg text-[0.95rem] leading-relaxed text-cosmic-900/75 sm:text-base lg:text-lg">
            ...
            {{-- Calls to action --}}
            <div class="mt-7 max-lg:[@media(max-height:700px)]:mt-5 flex flex-col gap-2.5 sm:flex-row sm:items-center sm:gap-3">
            ...
            {{-- Assurance pills --}}
            <ul class="mt-7 max-lg:[@media(max-height:700px)]:mt-5 flex flex-wrap items-center gap-2">
            ...
            {{-- Location marker --}}
            <p class="font-sub mt-6 inline-flex items-center gap-2 [@media(max-height:700px)]:hidden text-xs tracking-[0.12em] text-cosmic-900/55 uppercase">
