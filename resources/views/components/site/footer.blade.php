...
<footer class="relative w-full bg-cosmic-950 overflow-hidden pt-16 sm:pt-20 lg:pt-24 border-t border-gold-400/20">
    ...
    <div class="relative w-full overflow-hidden pointer-events-none select-none -mb-3 sm:-mb-5 lg:-mb-8">
        ...
        <div class="absolute inset-x-0 bottom-0 h-44 bg-[radial-gradient(ellipse_at_bottom,rgba(200,166,123,0.22),transparent_70%)] blur-2xl"></div>

        {{-- Watermark Text: Center letters shine in Soft Gold, fading to Cosmic Blue edges --}}
        <div class="w-full text-center whitespace-nowrap font-sub font-black uppercase tracking-tight text-[18vw] leading-[0.75] bg-[radial-gradient(ellipse_80%_100%_at_50%_30%,#dec5a7_0%,#c8a67b_35%,#856233_65%,rgba(18,42,66,0.15)_95%)] bg-clip-text text-transparent">
            MILKYWAY
        </div>
    </div>
</footer>
